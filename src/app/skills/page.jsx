...
import { Github, Linkedin, Facebook, MessageSquare } from "lucide-react";
import { 
  Code2, 
  Terminal, 
  Cpu, 
...
const skillData = [
  { name: "C", category: "Language", desc: "Low-level programming and system logic.", icon: <Code2 size={32} />, color: "bg-blue-100 text-blue-600" },
  { name: "C++", category: "Language", desc: "Powerful OOP and game development.", icon: <FileCode size={32} />, color: "bg-indigo-100 text-indigo-600" },
  { name: "Java", category: "Language", desc: "Robust backend and Android apps.", icon: <Cpu size={32} />, color: "bg-red-100 text-red-600" },
  { name: "Linux", category: "OS/Tools", desc: "Server management and bash scripting.", icon: <Terminal size={32} />, color: "bg-gray-200 text-gray-800" },
  { name: "Python", category: "Language", desc: "Data Science, AI, and Automation.", icon: <Globe size={32} />, color: "bg-yellow-100 text-yellow-700" },
  { name: "HTML/CSS", category: "Frontend", desc: "Web structure and visual styling.", icon: <Layout size={32} />, color: "bg-orange-100 text-orange-600" },
  { name: "React Vite", category: "Frontend", desc: "Lightning fast modern web apps.", icon: <Layers size={32} />, color: "bg-cyan-100 text-cyan-600" },
  { name: "Tailwind CSS", category: "Frontend", desc: "Rapid UI development with utility classes.", icon: <Wrench size={32} />, color: "bg-teal-100 text-teal-600" },
  { name: "Daisy UI", category: "Frontend", desc: "Premium Tailwind components.", icon: <Smartphone size={32} />, color: "bg-pink-100 text-pink-600" },
  { name: "Node.js", category: "Backend", desc: "High-performance JS server runtime.", icon: <Server size={32} />, color: "bg-green-100 text-green-600" },
  { name: "Next.js", category: "Fullstack", desc: "The React framework for production.", icon: <Globe size={32} />, color: "bg-slate-200 text-black" },
  { name: "MySQL", category: "Database", desc: "Structured data and SQL management.", icon: <Database size={32} />, color: "bg-blue-100 text-blue-800" },
  { name: "PHP", category: "Backend", desc: "Server-side scripting for dynamic web.", icon: <ShieldCheck size={32} />, color: "bg-purple-100 text-purple-600" },
];
